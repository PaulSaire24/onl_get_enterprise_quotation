...
public class QuotationBean {
    ...
    public static QuotationDAO transformQuotationMapToBean(Map<String,Object> map){
        ...
        quotationDAO.setInsuranceModalityType((String) map.get(
                ConstantsUtil.InsurancePrdModality.FIELD_INSURANCE_MODALITY_TYPE));
        quotationDAO.setInsuranceProductType((String) map.get(
        ...
        quotationDAO.setInsuranceCompanyModalityId((String) map.get(
                ConstantsUtil.InsurancePrdModality.FIELD_INSURANCE_COMPANY_MODALITY_ID));
        ...
        quotationDAO.setPolicyQuotaStatusType((String) map.get(
                ConstantsUtil.QuotationMap.FIELD_POLICY_QUOTA_STATUS_TYPE));
